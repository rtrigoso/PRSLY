...
assert_pos "green is adjective in 'my favorite color is green'" \
    "my favorite color is green" "green" "adjective"

# Attributive adjective between possessive pronoun and noun
assert_pos "favorite is adjective in 'my favorite color is green'" \
    "my favorite color is green" "favorite" "adjective"

# Adverb -ly should not be misclassified as adjective -ly
assert_pos "quickly is adverb in 'the tree felt quickly into the ground'" \
    "the tree felt quickly into the ground" "quickly" "adverb"

# Morphological adjective suffixes
assert_pos "beautiful is adjective in 'she is beautiful'"  "she is beautiful"  "beautiful"  "adjective"
assert_pos "careful is adjective in 'he is careful'"       "he is careful"     "careful"    "adjective"
assert_pos "helpless is adjective in 'it is helpless'"     "it is helpless"    "helpless"   "adjective"
assert_pos "famous is adjective in 'she is famous'"        "she is famous"     "famous"     "adjective"

# From "The only person you are destined to become is the person you decide to be."
assert_pos "only is adjective in 'The only person you are destined to become is the person you decide to be.'" \
...
assert_pos "classic is adjective in 'Moby Dick is a classic story about challenges and obsession.'" \
